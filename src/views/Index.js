...
export default function Index() {
  return (
    <>
      <IndexNavbar fixed />
      <section className="header bg-overlay land1   relative pt-16 items-center flex h-screen max-h-860-px">
        <div className="container  mx-auto items-center flex flex-wrap">
          <div className=" w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0  ">
              <h2 className="font-semibold text-4xl text-white-600">
                Detection Online is now much easier.
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-white-600">
              Smart is an interesting platform that will guide you in more an interactive way.
                {" "}
      ...
      <div className="justify-center text-center flex flex-wrap mt-24">
          <div className="w-full md:w-6/12 px-12 md:px-4">
            <h2 className="font-semibold text-4xl">How to Prevent Virus</h2>
